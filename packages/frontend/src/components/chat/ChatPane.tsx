...
const ChatPane = () => {
    ...
    return (
        <div className="relative flex h-full flex-col bg-background">
            ...
            <ScrollArea
                className="flex-1 min-h-0 min-w-0 px-0 md:px-4 relative -mt-1 max-w-full overflow-x-hidden"
                ref={scrollAreaRef}
            >
                ...
                <div className="flex flex-col gap-4 pt-9 w-full max-w-full box-border px-2 md:px-4">
                    {messages.map((msg) => {
                        let branchInfo;
                        if (msg.parentId) {
