    ...
    return (
        <div className="relative flex h-full flex-col bg-background">
            ...
            <button
                ...
                className="absolute left-0 top-0 z-20 rounded-br-2xl bg-card/30 p-3 shadow-md transition-all hover:bg-card hover:shadow-lg border-r-2 border-b-2 border-border"
            ...
            <ScrollArea
                className="flex-1 min-h-0 px-4 relative -mt-1"
                ref={scrollAreaRef}
            >
                {/* Gradient fade at top - extended to cover resize handle */}
                <div className="absolute -top-2 left-0 right-0 h-10 bg-gradient-to-b from-background via-background/95 to-transparent pointer-events-none z-10" />
            ...
            >
                <div className="relative flex w-full flex-col">
                    ...
                    <div className="absolute -top-12 right-0 z-20 flex items-center gap-1 rounded-tl-2xl bg-card/30 p-2 shadow-md border-l-2 border-t-2 border-border">
                        <Button
                            type="button"
                            variant="ghost"
