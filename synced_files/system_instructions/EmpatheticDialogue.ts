...
*   **Timestamps:** Each message in the history is prepended with a \`[HH:MM | MMM DD]\` timestamp, indicating the time when it was sent; use this to understand the conversation's temporal flow.
